...
from my_dataset import FS2K_DataSet
from models.swin import FaceAttrModel
from utils import read_train_test, train_one_epoch, evaluate
...
def main(args):
    ...
    train_dataset = FS2K_DataSet(attrs=train_attrs, transform=data_transform["train"])
    val_dataset = FS2K_DataSet(attrs=test_attrs, transform=data_transform["test"])
    ...
    for epoch in range(args.epochs):
        ...
        print(
            "test: hair: {:.3f}, hair_color: {:.3f}, gender: {:.3f}, earring: {:.3f}, smile: {:.3f}, frontal_face: {:.3f}, style: {:.3f},val_map:{:.3f}".format(
