...
class FeatureExtraction(nn.Module):
    def __init__(self):
        ...
        d = torch.load('/data2/yuhao/checkpoint/20180402-114759-vggface2.pt', map_location='cpu')
...
class FaceAttrModel(nn.Module):
    ...
    def get_loss(self, net_output, ground_truth, device):
        ...
        # loss = hair_loss + gender_loss + earring_loss + smile_loss + frontal_face_loss + style_loss
